...
pub mod prelude {
    ...
    pub use super::{
        ...
        get_test_pt, BufferPool, ContainerId, ContainerKey, DashmapBP, DatabaseId, FrameReadGuard,
        FrameWriteGuard, HashmapBP, InMemPool, MemPool, MemPoolStatus, OpenAddressingBP,
        OverflowBP, PageFrameKey, PredictiveTranslationBP, PredictiveTranslationFPBP,
    };
}
